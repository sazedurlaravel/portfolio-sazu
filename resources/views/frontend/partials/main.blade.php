                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            <div class="cat-icon">
                               <img src="{{asset('frontend/assets/img/logo/psd.png')}}" alt="Logo" width="100" style="margin-bottom: 10px;">
                            </div>
                            <div class="cat-cap">
                                <h5><a href="services.html">PSD to HTML</a></h5>
                                <p>I will convert psd to html, xd to html, sketch to html responsive.</p>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-4 col-md-6 col-sm-6">
