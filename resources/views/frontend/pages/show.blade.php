                            ...
                            <div class="properties__button">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        @foreach($categories as $category)
                                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#{{$category->id}}" role="tab" aria-controls="nav-profile" aria-selected="false">{{$category->name}}</a>
                                        @endforeach
                        ...
                        <div class="tab-content active" id="nav-tabContent">
                            ...
                            @if($projects->count()>0)
                                 @foreach($projects as $project)
                                        <div class="tab-pane fade" id="{{$category->id}}" role="tabpanel" aria-labelledby="nav-profile-tab">
            ...
            <div class="container">
                <div class="brand-active brand-border pt-50 pb-40">
                    <div class="single-brand">
                        <img src="{{asset('frontend/assets/img/gallery/brand1.png')}}" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="{{asset('frontend/assets/img/gallery/brand2.png')}}" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="{{asset('frontend/assets/img/gallery/brand3.png')}}" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="{{asset('frontend/assets/img/gallery/brand4.png')}}" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="{{asset('frontend/assets/img/gallery/brand2.png')}}" alt="">
                    </div>
