...
<head>
        ...
        <link rel="stylesheet" href="backend/css/matrix-login.css" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="{{route('login')}}" method="post">
                @csrf
				 <div class="control-group normal_text"> <h3><img src="backend/img/logo.png" alt="Logo" /></h3></div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="password">
                        </div>
                    </div>
                </div>
        ...
        <script src="backend/js/matrix.login.js"></script> 
    </body>
